                ...
                <td class="align-middle">
                    <div class="btn-group">
                        @if ($kehamilan->periksaKehamilans->count() > 0)
                            <a href="{{ route('ibu.periksa.edit', $kehamilan->id) }}" class="btn btn-warning"
                                data-toggle="tooltip" title="Edit Periksa">
                                <i class="fas fa-edit"></i>
                            </a>
                        @else
                            <a href="{{ route('ibu.periksa.tambah', $kehamilan->id) }}" class="btn btn-success"
                                data-toggle="tooltip" title="Periksa">
