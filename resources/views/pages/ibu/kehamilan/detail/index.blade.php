                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group mb-2">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <input type="text" value="{{ $kehamilan->bulan }}" name="bulan" id="bulan" class="form-control mr-2"
                                                            style="flex: 1;" disabled>
                                                        <input type="text" value="{{ $kehamilan->tahun }}" name="tahun" id="tahun" class="form-control"
                                                            style="flex: 1;" disabled>
                                                    </div>
                                                ...
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="text" value="{{ $kehamilan->kontrasepsi }}"
                                                        name="kontrasepsi" id="kontrasepsi" class="form-control" readonly>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="text" value="{{ $kehamilan->bidan }}" name="bidan"
                                                        id="bidan" class="form-control" readonly>
                                    ...
                                    <form id="form-persalinan">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <textarea name="detail_keadaan_ibu" id="detail_keadaan_ibu" class="form-control" rows="2" readonly>{{ $kehamilan->persalinan->detail_keadaan_ibu }}</textarea>
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="text" name="kb_pasca_persalinan" id="kb_pasca_persalinan"
                                                    class="form-control"
                                                    value="{{ $kehamilan->persalinan->kb_pasca_persalinan }}" readonly>
                                                <div class="invalid-feedback" id="error-kb_pasca_persalinan"></div>
                                            </div>

                                            <div class="form-group mb-2">
                                                <label for="keterangan_tambahan">Keterangan Tambahan</label>
                                                <textarea name="keterangan_tambahan" id="keterangan_tambahan" class="form-control" rows="2" readonly>{{ $kehamilan->persalinan->keterangan_tambahan }}</textarea>
                                    ...
                                    <div>
                                        <form id="form-bayi">
                                            ...
                                            <input type="hidden" name="persalinan_id" id="persalinan_id"
                                                value="{{ $kehamilan->persalinan->id }}" readonly>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group mb-2">
                                                    <label for="keterangan_tambahan">Keterangan Tambahan</label>
                                                    <textarea name="keterangan_tambahan" id="keterangan_tambahan" class="form-control" rows="2" readonly>{{ $kehamilan->persalinan->bayi->keterangan_tambahan }}</textarea>
                                                </div>
                                            </div>
                                    ...
                                    <div>
                                        <form id="form-kunjungan-nifas">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mb-2">
                                                            ...
                                                            <textarea name="masalah" id="masalah" class="form-control" rows="2" readonly>{{ $kehamilan->persalinan->kunjunganNifas->masalah }}</textarea>
                                                        </div>

                                                        <div class="form-group mb-2">
                                                            <label for="tindakan">Tindakan</label>
                                                            <textarea name="tindakan" id="tindakan" class="form-control" rows="2" readonly>{{ $kehamilan->persalinan->kunjunganNifas->tindakan }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-2">
                                                    <label for="keterangan_tambahan">Keterangan Tambahan</label>
                                                    <textarea name="keterangan_tambahan" id="keterangan_tambahan_kunjungan" class="form-control" rows="2"
                                                        readonly>{{ $kehamilan->persalinan->kunjunganNifas->keterangan_tambahan }}</textarea>
                                                </div>
                                            </div>
                                        ...
                                        <form id="form-kesimpulan-nifas">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group mb-2">
                                                    ...
                                                    <textarea name="catatan" id="catatan" class="form-control" rows="2" readonly>{{ $kehamilan->persalinan->kesimpulanNifas->catatan }}</textarea>
                                                </div>

                                                <div class="form-group mb-2">
                                                    <label for="kesimpulan">Kesimpulan</label>
                                                    <textarea name="kesimpulan" id="kesimpulan" class="form-control" rows="3" required readonly>{{ $kehamilan->persalinan->kesimpulanNifas->kesimpulan }}</textarea>
