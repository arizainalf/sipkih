                ...
                <td class="align-middle">
                    <div class="btn-group">
                        ...
                        <button data-toggle="modal" data-target="#modal-tambah" type="button"
                            class="btn btn-warning edit-button" data-id="{{ $pelayanan->id }}" data-toggle="tooltip"
                            title="Edit">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button
                            onclick="confirmDelete('{{ route('admin.pelayanan.destroy', $pelayanan->id) }}','.table-responsive', '{{ route('admin.pelayanan.index') }}', '#tabel-pelayanan')"
