...
@section('content')
                        ...
                        <div class="card-header">
                            <div class="card-header">
                                <div class="card-title font-weight-bolder">
                                    <h3 class="text-primary">@yield('title')
                                    </h3>
                                    <h4 class="text-primary">{{ $ibu->nik }}
                                    </h4>
                                </div>
                                <div class="ml-auto">
    ...
    @include('pages.admin.ibu.detail.modal')
@endsection
@push('scripts')
    <!-- JS Libraies -->
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '#form-tambah', function(e) {
                ...
                let url = '{{ route('admin.kehamilan.store') }}';
                ...
                const successCallback = function(response) {
                    ...
                    loadData('.table-responsive', "{{ route('admin.ibu.detail', $ibu->id) }}",
                        "#tabel-kehamilan")
                }
            ...
            loadData('.table-responsive', "{{ route('admin.ibu.detail', $ibu->id) }}", "#tabel-kehamilan")
        })
    </script>
@endpush
