        ...
        @forelse ($kehamilans as $index => $kehamilan)
            <tr>
                ...
                <td class="align-middle">
                    <div class="btn-group">
                        <button type="button" class="btn btn-info edit-button" data-toggle="tooltip" title="Detail">
                        ...
                        <button
                            onclick="confirmDelete('{{ route('admin.kehamilan.destroy', $kehamilan->id) }}','.table-responsive', '{{ route('admin.ibu.detail', $kehamilan->id) }}', '#tabel-kehamilan')"
