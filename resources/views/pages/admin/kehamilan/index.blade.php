...
@section('content')
    ...
    @include('pages.admin.kehamilan.modal')
@endsection
@push('scripts')
    <!-- JS Libraies -->
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#tambah-button', function(e) {
                ...
                loadSelectOptions('#ibu_id', '{{ route('admin.ibu.index') }}')
            ...
            $(document).on('submit', '#form-tambah', function(e) {
                ...
                const successCallback = function(response) {
                    ...
                    loadData('.table-responsive', "{{ route('admin.kehamilan.table') }}",
                        "#tabel-kehamilan")
                }
            ...
            loadData('.table-responsive', "{{ route('admin.kehamilan.table') }}", "#tabel-kehamilan")
        })
    </script>
@endpush
